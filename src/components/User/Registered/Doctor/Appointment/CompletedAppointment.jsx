...
export default function CompletedAppointment(){
   ...
   const fetchAppointment=async()=>{
      try{
         const response=await axios.get(`${baseUrl}api/doctor/appointments/${userInfo.id}/?status=${'completed'}`,{headers:{'Authorization':userInfo.token}})
   ...
   return (
      <> 
      <h1 className="text-[30px] font-bold">Completed Appointments</h1>
